      ...
      <View style={estilos.subContainer}>
        <ScrollView>
          <Text style={estilos.titulo}>
            Política de Privacidade para o app Cinéfilos
          </Text>

          <Text style={estilos.texto}>
            A sua privacidade é importante para nós. É política do Cinéfilos
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site Cinéfilos, e outros sites que possuímos e
            operamos.
          </Text>
